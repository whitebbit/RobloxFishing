        ...
        static void AnalyzeModels()
        {
            ...
            foreach (var modelPath in usedModelPaths)
            {
                ...
                try
                {
                    ...
                    treeElements.Add(new ModelTreeItem("NpcModel", 0, idIncrement, modelPath, modelImporter));
                }
                catch (Exception)
                {
            ...
            if (_multiColumnHeaderState == null)
                _multiColumnHeaderState = new MultiColumnHeaderState(new[]
                {
                    ...
                    new MultiColumnHeaderState.Column() { headerContent = new GUIContent() { text = "NpcModel" }, width = 150, minWidth = 150, canSort = true },
