...
namespace _3._Scripts.UI.Panels
{
    public class CharacterShop : ShopPanel<CharacterItem, CharacterShopSlot>
    {
        ...
        {
            return Configuration.Instance.AllCharacters.OrderBy(obj => obj.Price);
        }
        ...
        protected override bool Buy(string id)
        {
            ...
            return data.PurchaseType switch
            {
                PurchaseType.Currency => CurrencyBuy(data),
                PurchaseType.Ad => AdBuy(data),
